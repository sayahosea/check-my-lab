...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE PROCEDURE IF NOT EXISTS sp_create_lab_account (
            ...
            BEGIN
                ...
                VALUES (id_akun, 'LAB', arg_full_name, arg_phone_number);
    ...
    {
        DB::statement('DROP PROCEDURE IF EXISTS sp_create_lab_account');
    }
};
