...
<div id="modalPasien" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
  <div class="bg-white rounded shadow-lg w-full max-w-md p-6 relative">
    ...
    <!-- Judul -->
    <h2 class="text-xl font-semibold text-center mb-4">Tambah Pegawai</h2>

    <!-- Form Input -->
    <form id="formPasien" class="space-y-3">
      <input type="text" placeholder="Nama" class="w-full border rounded px-3 py-2" />
      <input type="text" placeholder="Bagian" class="w-full border rounded px-3 py-2" />
      <input type="text" placeholder="Nomor Telepon" class="w-full border rounded px-3 py-2" />
      <input type="text" placeholder="Kata Sandi" class="w-full border rounded px-3 py-2" />
...
<script>
  ...
  document.getElementById("formPasien").addEventListener("submit", function (e) {
    ...
    <table class="w-full table-auto text-sm border-collapse">
      <thead>
        <tr class="bg-[#a8dadc] text-left text-semi-bold">
